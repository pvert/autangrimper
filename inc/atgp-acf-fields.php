...
if( function_exists('acf_add_local_field_group') ):
    ...
    <p>L\'adhésion au club inclue une assurance responsabilité civile et spécifique escalade, pour cela nous vous demandons d\'imprimer le <a href="'.plugins_url("../files/2025-pack-assurance.pdf", __FILE__).'">contrat assurance pré-rempli</a> (bonnes cases cochées par défaut).
